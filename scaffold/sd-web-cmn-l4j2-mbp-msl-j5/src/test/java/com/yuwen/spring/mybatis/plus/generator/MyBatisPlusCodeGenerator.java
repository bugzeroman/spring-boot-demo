package com.yuwen.spring.mybatis.plus.generator;
...
public class MyBatisPlusCodeGenerator {
	...
	// 包名和模块名
	private static final String PACKAGE_NAME = "com.yuwen.spring";
	private static final String MODULE_NAME = "demo";

	// 表名，多个表使用英文逗号分割
	private static final String[] TBL_NAMES = { "tbl_user", "tbl_role", "tbl_user_role" };
